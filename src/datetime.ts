...
export class DateTime {
    ...
    static fromFormat(text: string, fmt: string, opts: DateTimeOptions = {}): DateTime {
        ...
        if (invalid) {
            ...
            return DateTime.parseDataToDateTime(vals as GenericDateTimeExtended, parsedZone || null, opts, `format ${fmt}`, text, specificOffset);
        }
    }
    ...
    static fromFormatParser(text: string, formatParser: TokenParser, opts: DateTimeOptions = {}): DateTime {
        ...
        if (invalidReason) {
            ...
            return DateTime.parseDataToDateTime(
                result,
                zone,
                opts,
    ...
    static fromObject(obj: DurationObject & GenericDateTime = {},
        ...
        const offsetProvis = isNumber(opts.specificOffset)
            ? opts.specificOffset
     ...
     */
    static parseDataToDateTime(parsed: GenericDateTime | null | void,
