...
test("Interval.fromISO can parse a variety of ISO formats", () => {
  const check = (s: string, ob1: GregorianDateTime, ob2: GregorianDateTime) => {
...
describe("Interval.fromISO defaults missing values in end to start", () => {
    ...
    test("Gregorian with start zone", () => {
        ...
        expect(i.start.toISO()).toBe("1988-04-15T10:00:00.000+02:00");
        expect(i.end.toISO()).toBe("1988-04-17T16:30:00.000+02:00");
    });
    ...
    test("Week, end just time", () => {
        ...
        expect(i.start.toISO()).toBe("2025-05-12T09:00:00.000+02:00");
        expect(i.end.toISO()).toBe("2025-05-12T15:30:00.000+02:00");
    });
    test("Week, end just time and zone", () => {
        const i = Interval.fromISO("2025-W20-1T09/15:30-07:00");
        expect(i.start.toISO()).toBe("2025-05-12T09:00:00.000+02:00");
        expect(i.end.toISO()).toBe("2025-05-13T00:30:00.000+02:00");
    });
    test("Week, end week day", () => {
        const i = Interval.fromISO("2025-W20-1T09/3T15:30");
        expect(i.start.toISO()).toBe("2025-05-12T09:00:00.000+02:00");
        expect(i.end.toISO()).toBe("2025-05-14T15:30:00.000+02:00");
    });
    test("Week, end week number and week day", () => {
        const i = Interval.fromISO("2025-W20-1T09/W21-3T15:30");
        expect(i.start.toISO()).toBe("2025-05-12T09:00:00.000+02:00");
        expect(i.end.toISO()).toBe("2025-05-21T15:30:00.000+02:00");
    });
    ...
    test("Ordinal, end with ordinal", () => {
        ...
        expect(i.start.toISO()).toBe("2025-05-12T09:00:00.000+02:00");
        expect(i.end.toISO()).toBe("2025-05-15T15:30:00.000+02:00");
    });
    ...
    test("Gregorian, end weekNumber and weekday", () => {
        ...
        expect(i.start.toISO()).toBe("2025-05-12T09:00:00.000+02:00");
        expect(i.end.toISO()).toBe("2025-05-19T15:30:00.000+02:00");
    });
    ...
    test("Week date, end month and day", () => {
        ...
        expect(i.start.toISO()).toBe("2025-05-12T09:00:00.000+02:00");
        expect(i.end.toISO()).toBe("2025-06-15T15:30:00.000+02:00");
    });
